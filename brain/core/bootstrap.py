...
from brain.repl.display_port import NullDisplayPort, RichConsoleDisplayPort
from brain.core.logging_setup import configure_logging
from brain.core.session import resolve_history_path
from brain.core.user_config import UserConfig, load_user_config_file
...
def bootstrap(
    ...
    *,
    ...
    history_path = resolve_history_path(
        vault_path,
        user.history_filename or '.agent_history.json',
        session_name,
    )
